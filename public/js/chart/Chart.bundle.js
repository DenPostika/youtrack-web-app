    ...
    return function t(e, a, i) {
            ...
            e.exports = function(t) {
                ...
                t.controllers.bar = t.DatasetController.extend({
                    ...
                    calculateBarX: function(t, e) {
                        ...
                        return l -= a.chart.isCombo ? r.tickWidth / 2 : 0,
                        n.options.stacked ? l + r.categoryWidth / 2 + r.categorySpacing : l + r.barWidth / 2 + r.categorySpacing + r.barWidth * o + r.barSpacing / 2 + r.barSpacing * o
                    },
                ...
                t.controllers.horizontalBar = t.controllers.bar.extend({
                    updateElement: function(t, a, i) {
                        ...
                        e.extend(t, {
                            ...
                            inRange: function(t, e) {
                                var a = this._view
                                  , i = !1;
                                return a && (i = a.x < a.base ? e >= a.y - a.height / 2 && e <= a.y + a.height / 2 && t >= a.x && t <= a.base : e >= a.y - a.height / 2 && e <= a.y + a.height / 2 && t >= a.base && t <= a.x),
                                i
                            }
                        }),
                        t.pivot()
                    ...
                    calculateBarY: function(t, e) {
                        var a = this
                          ...
                          , r = a.getRuler(t)
                          , l = n.getPixelForValue(null , t, e, a.chart.isCombo);
                        return l -= a.chart.isCombo ? r.tickHeight / 2 : 0,
                        n.options.stacked ? l + r.categoryHeight / 2 + r.categorySpacing : l + r.barHeight / 2 + r.categorySpacing + r.barHeight * o + r.barSpacing / 2 + r.barSpacing * o
                    }
                })
            }
        }
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        if ("monotone" == i.dataset._model.cubicInterpolationMode)
                            ...
                            l = o.length; l > r; ++r)
                                s = o[r],
                                d = s._model,
                                u = a.splineCurve(a.previousItem(o, r)._model, d, a.nextItem(o, r)._model, i.dataset._model.tension),
                        ...
                        if (e.chart.options.elements.line.capBezierPoints)
                            ...
                            l = o.length; l > r; ++r)
                                d = o[r]._model,
                                d.controlPointPreviousX = t(d.controlPointPreviousX, n.left, n.right),
                                d.controlPointPreviousY = t(d.controlPointPreviousY, n.top, n.bottom),
                                d.controlPointNextX = t(d.controlPointNextX, n.left, n.right),
                                d.controlPointNextY = t(d.controlPointNextY, n.top, n.bottom)
                    },
                    draw: function(t) {
            ...
            e.exports = function(t) {
                ...
                e.extend(t.Controller.prototype, {
                    ...
                    resize: function(a) {
                        ...
                        return t.plugins.notify("resize", [i, u]),
                    ...
                    buildOrUpdateControllers: function() {
                        ...
                        if (e.each(a.data.datasets, function(e, o) {
                            ...
                            i.push(r.type),
                            r.controller ? r.controller.updateIndex(o) : (r.controller = new t.controllers[r.type](a,o),
                            n.push(r.controller))
                        }, a),
                        i.length > 1)
                    ...
                    render: function(a, i) {
                        ...
                        if (o && ("undefined" != typeof a && 0 !== a || "undefined" == typeof a && 0 !== o.duration)) {
                            ...
                            n.draw(),
                            o && o.onComplete && o.onComplete.call && o.onComplete.call(n);
                        return n
                    },
                    draw: function(a) {
                        var i = this
                    ...
                    destroy: function() {
                        ...
                        void 0 !== a.chart.originalDevicePixelRatio && a.chart.ctx.scale(1 / a.chart.originalDevicePixelRatio, 1 / a.chart.originalDevicePixelRatio),
                    ...
                    eventHandler: function(t) {
                        ...
                        "mouseout" === t.type ? (a.active = [],
                        a.tooltipActive = []) : (a.active = a.getElementsAtEventForMode(t, o.mode),
                        ...
                        (r.enabled || r.custom) && (i.initialize(),
                        i._active = a.tooltipActive,
                        i.update(!0)),
                        i.pivot(),
                        a.animating || e.arrayEquals(a.active, a.lastActive) && e.arrayEquals(a.tooltipActive, a.lastTooltipActive) || (a.stop(),
                ...
                e.extend(t.DatasetController.prototype, {
                    ...
                    setHoverStyle: function(t) {
                        var a = this.chart.data.datasets[t._datasetIndex]
                          ...
                          , r = e.getHoverColor
                          , l = t._model;
                        l.backgroundColor = n.hoverBackgroundColor ? n.hoverBackgroundColor : o(a.hoverBackgroundColor, i, r(l.backgroundColor)),
        ...
        26: [function(t, e, a) {
            ...
            e.exports = function(t) {
                ...
                ,
                o.color = function(e) {
                    return i ? i(e instanceof CanvasGradient ? t.defaults.global.defaultColor : e) : (console.log("Color.js not found!"),
                    e)
                }
                ,
                ...
                t.layoutService = {
                    ...
                    update: function(t, a, i) {
                        function n(t) {
                            ...
                            a ? (e = t.update(t.options.fullWidth ? p : k, y),
                            S -= e.height) : (e = t.update(x, v),
                            k -= e.width),
                            w.push({
                                horizontal: a,
                                minSize: e,
                        ...
                        function l(t) {
                            t.isHorizontal() ? (t.left = t.options.fullWidth ? s : C,
                ...
                t.Legend = t.Element.extend({
                    ...
                    fit: function() {
                        var a = this
                          ...
                          , g = a.minSize
                          , p = a.isHorizontal();
                        if (p ? (g.width = a.maxWidth,
                        g.height = o ? 10 : 0) : (g.width = o ? 10 : 0,
                        ...
                        o)
                            ...
                            p) {
                                ...
                                e.each(a.legendItems, function(t, e) {
                                    ...
                                    m[m.length - 1] + o + n.padding >= a.width && (b += d + n.padding,
                                    m[m.length] = a.left),
                                    f[e] = {
                                        left: 0,
                                        top: 0,
                    ...
                    draw: function() {
                        ...
                        if (i.display) {
                            ...
                            e.each(a.legendItems, function(t, e) {
                                ...
                                k ? r + o >= l && (c = d.y += S,
                                d.line++,
                                r = d.x = a.left + (l - s[d.line]) / 2) : c + S > a.bottom && (r = d.x = r + a.columnWidths[d.line] + n.padding,
                                c = d.y = a.top,
                                d.line++),
                                x(r, c, t),
                                v[e].left = r,
                    ...
                    draw: function(a) {
                        ...
                        if (n.display) {
                            ...
                            if (g) {
                                if (o = !1,
                                h && (T /= 2),
                                (T + d.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) && (o = 1 + Math.floor((T + d.autoSkipPadding) * i.ticks.length / (i.width - (i.paddingLeft + i.paddingRight)))),
                                r && i.ticks.length > r)
                                ...
                                if (void 0 !== t && null !== t) {
                                    ...
                                    if ((!s || l) && void 0 !== t && null !== t) {
                                        ...
                                        if (g) {
                                            ...
                                            P = "left") : (D = i.right - d.padding,
                                            P = "right") : d.mirror ? (D = i.left - d.padding,
                                            P = "right") : (D = i.left + d.padding,
                                            P = "left");
                            ...
                            if (u.drawBorder) {
                                ...
                                g ? (E = U = "top" === n.position ? i.bottom : i.top,
                                E += q,
                                U += q) : (N = H = "left" === n.position ? i.right : i.left,
                                N += q,
                                H += q),
                                l.beginPath(),
                                l.moveTo(N, E),
                ...
                t.Title = t.Element.extend({
                    ...
                    draw: function() {
                        ...
                        if (o.display) {
                            ...
                            i.font = h,
                            a.isHorizontal() ? (l = p + (b - p) / 2,
                            s = g + (m - g) / 2) : (l = "left" === o.position ? p + d / 2 : b - d / 2,
                            s = g + (m - g) / 2,
                            f = Math.PI * ("left" === o.position ? -.5 : .5)),
                            i.save(),
                            i.translate(l, s),
                            i.rotate(f),
                            i.textAlign = "center",
                ...
                t.Tooltip = t.Element.extend({
                    ...
                    update: function(t) {
                        ...
                        if (d.length) {
                            ...
                            r._model.opacity = 0;
                        return t && l.custom && l.custom.call(r, s),
                        r
                    },
                    getTooltipSize: function(t) {
                        ...
                        ;
                        return e.font = n.fontString(s, t._titleFontStyle, t._titleFontFamily),
                        n.each(t.title, h),
                    ...
                    determineAlignment: function(t) {
                        ...
                        ,
                        o(a.x) ? (a.xAlign = "left",
                        l(a.x) && (a.xAlign = "center",
                        a.yAlign = d(a.y))) : r(a.x) && (a.xAlign = "right",
                        s(a.x) && (a.xAlign = "center",
                        a.yAlign = d(a.y)))
                    },
                    getBackgroundPoint: function(t, e) {
                        var a = {
                          ...
                          , s = i + n
                          , d = o + n;
                        return "right" === r ? a.x -= e.width : "center" === r && (a.x -= e.width / 2),
                        "top" === l ? a.y += s : "bottom" === l ? a.y -= e.height + s : a.y -= e.height / 2,
                        "center" === l ? "left" === r ? a.x += s : "right" === r && (a.x -= s) : "left" === r ? a.x -= d : "right" === r && (a.x += d),
                        a
                    },
                    drawCaret: function(t, e, a) {
                        var i, o, r, l, s, d, u = this._view, c = this._chart.ctx, h = u.caretSize, f = u.cornerRadius, g = u.xAlign, p = u.yAlign, m = t.x, b = t.y, v = e.width, x = e.height;
                        "center" === p ? ("left" === g ? (i = m,
                        o = i - h,
                        r = i) : (i = m + v,
                        o = i + h,
                    ...
                    drawBody: function(t, e, a, i) {
                        ...
                        n.each(l, function(r, l) {
                            ...
                            n.each(r.lines, function(r) {
                                h && (a.fillStyle = n.color(e.legendColorBackground).alpha(i).rgbaString(),
            ...
            e.exports = function(t) {
                ...
                t.elements.Line = t.Element.extend({
                    draw: function() {
                        function t(t, e) {
                            var a = e._view;
                            e._view.steppedLine === !0 ? (s.lineTo(e._view.x, t._view.y),
                            s.lineTo(e._view.x, e._view.y)) : 0 === e._view.tension ? s.lineTo(a.x, a.y) : s.bezierCurveTo(t._view.controlPointNextX, t._view.controlPointNextY, a.controlPointPreviousX, a.controlPointPreviousY, a.x, a.y)
                        }
                        var i = this
                          , n = i._view
                          , o = n.spanGaps
                ...
                t.elements.Point = t.Element.extend({
                    ...
                    draw: function() {
                        var n = this._view
                          ...
                          , s = n.x
                          , d = n.y;
                        n.skip || (o.strokeStyle = n.borderColor || i,
                        ...
                        i.stacked) {
                            ...
                            e.each(r, function(o, r) {
                                ...
                                n.isDatasetVisible(r) && t(l) && e.each(o.data, function(t, e) {
                                    ...
                                    isNaN(n) || l.data[e].hidden || (c[e] = c[e] || 0,
                                    h[e] = h[e] || 0,
                                    i.relativePoints ? c[e] = 100 : 0 > n ? (u = !0,
                                    h[e] += n) : (d = !0,
                                    c[e] += n))
                                })
                            }),
                  ...
                  , i = t.Scale.extend({
                    ...
                    buildTicks: function() {
                        for (var t = this, a = t.options, i = a.ticks, n = e.getValueOrDefault, o = t.ticks = [], r = n(i.min, Math.pow(10, Math.floor(e.log10(t.min)))); r < t.max; ) {
                            o.push(r);
                            var l, s;
                            0 === r ? (l = Math.floor(e.log10(t.minNotZero)),
                            s = Math.round(t.minNotZero / Math.pow(10, l))) : (l = Math.floor(e.log10(r)),
                        ...
                        if (i.display) {
                            ...
                            !i.lineArc) {
                                ...
                                for (var g = t.getDistanceFromCenterForValue(i.reverse ? t.min : t.max), p = s(l.fontSize, a.defaultFontSize), m = s(l.fontStyle, a.defaultFontStyle), b = s(l.fontFamily, a.defaultFontFamily), v = e.fontString(p, m, b), x = t.getValueCount() - 1; x >= 0; x--) {
                                    ...
                                    0 === M || 180 === M ? d.textAlign = "center" : 180 > M ? d.textAlign = "left" : d.textAlign = "right",
                                    90 === M || 270 === M ? d.textBaseline = "middle" : M > 270 || 90 > M ? d.textBaseline = "bottom" : d.textBaseline = "top",
                ...
                var e = t.helpers
                  ...
                  , o = t.Scale.extend({
                    ...
                    buildTicks: function() {
                        ...
                        (0 !== C || 0 === i.scaleSizeInUnits) && (i.options.time.max ? (i.ticks.push(i.lastTick.clone()),
